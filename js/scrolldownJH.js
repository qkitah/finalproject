//to adapt to mobile//
//ref: http://stackoverflow.com/questions/11381673/detecting-a-mobile-browser
...
//end of function to adapt to mobile//
...
$(document).on("ready",function(){
  ...
  //adapt to mobile//
  if( mobilecheck() ) { //if we have mobile device
    //let's add class .mobile to the body
